...
from Avenger import BOT_NAME, MESSAGE_DUMP_CHAT, SUDOERS, app, arq
from Avenger.core.keyboard import ikb
from Avenger.core.tasks import _get_tasks_text, all_tasks, rm_task
from Avenger.core.types import InlineQueryResultCachedDocument
from Avenger.modules.info import get_chat_info, get_user_info
from Avenger.modules.music import download_youtube_audio
from Avenger.utils.functions import test_speedtest
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/2079b686ea131a7bda2cd.jpg",
            input_message_content=InputTextMessageContent(
