...
from Avenger import BOT_USERNAME, SUDOERS, app, eor
from Avenger.core.decorators.errors import capture_err
from Avenger.utils.dbfunctions import del_packname, get_packname, set_packname
from Avenger.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)
from Avenger.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,
