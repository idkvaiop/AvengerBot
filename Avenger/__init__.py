...
# MongoDB client
print("[AVENGER]: INITIALIZING DATABASE")
...
print("[AVENGER]: STARTING BOT CLIENT")
app.start()

print("[AVENGER]: GATHERING PROFILE INFO")
x = app.get_me()
